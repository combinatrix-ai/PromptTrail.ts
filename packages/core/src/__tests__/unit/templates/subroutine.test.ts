...
import { Subroutine, Sequence, Loop } from '../../../templates';
...
describe('SubroutineTemplate', () => {
  ...
  it('should support adding templates via constructor array', async () => {
    ...
    const systemTemplate = new Subroutine().addSystem('System instruction');
    const userTemplate = new Subroutine().addUser('User message');
    const assistantTemplate = new Subroutine().addAssistant(
      'Assistant response',
    );
